...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: "Showcase",
    paragraph:
      "Below is some of my professional and personal work that I am most proud of. Check them out on GitHub and download or visit where possible!",
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12">Dealer Showroom</h3>
                <p className="m-0">
                  ...
                  branding and info than we had previously shown. My very first
                  large screen I worked on at Trade Me.
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12">Reminder+</h3>
                <p className="m-0">
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12">OneRoom</h3>
                <p className="m-0">
                  A web app developed using the MERN stack at Uni for a final
                  year group project. It was created around the idea of
                  replacing the paper based study room booking system at the uni
                  with an online one complete with accounts.
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8">
                  Azure Multi-VM MERN Stack App
                </div>
                <h3 className="mt-0 mb-12">To-do List Web App</h3>
                <p className="m-0">
                  A multi-VM web app created using the MERN stack on the Azure
                  cloud platform. An exercise in learning about VM's in the
                  cloud and cross communication between them. Based around a
